      ...
      <div className="space-y-2">
        {displayItems.map((item: any, index: number) => (
          <div key={index} className="flex items-center space-x-2">
            {item.image_url || item.imageUrl || item.image || item.product_image || item.product_image_url ? (
              <img
                src={item.image_url || item.imageUrl || item.image || item.product_image || item.product_image_url}
